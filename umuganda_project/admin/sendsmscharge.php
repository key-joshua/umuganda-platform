...
?>
	...
	<div class="input-group">
		<form method="post" action="send_done.php">
			...
			<textarea  name="message" value="hdbsds" ><?php $target =date("Y"); $targeta =date("M"); $targetb = date("d"); echo "Muraho Neza Muributswa Kwishyura Amafaranga Y 'amanade 500frw Yokuba Mutitabiriye Umuganda Wari Kuri uyumunsi W' icyicyumeru Gisoza Ukukwezi Le"." ".$target." ".$targeta." ".$targetb; ?></textarea>
