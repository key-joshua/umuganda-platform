...
<div class="header">
	...
	<h2>Bonus Attendance</h2>

</div>

<form method="post" action="bonus_inserts.php" style="background-image: linear-gradient(135deg, #fdfcfb 0%, #423107 100%);" >
...
<input type="text" name="MONTHS" value="Jan" id="months" style="display: none;">	
<input type="text" name="DATES" value="25" id="dates" style="display: none;">	
...
<p>
	...
	Wanna Check Attendance ? 
	&nbsp;
	<a href="people_details.php" style="color: #271c02; font-size: 20px;"  >Check Now !!</a>
