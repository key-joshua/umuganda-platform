...
<h2>
  ...
  <a onclick="return confirm('Are you sure !! You want to check absent ?')" style="color: #674d0d; font-size: 20px; " href="absent.php" >Absents Attendance</a>

</h2>

  </div>

   <div class="reg" style="width: 15%; "> 

<h2>

  <a onclick="return confirm('Are you sure !! You want to check Present ?')" style="color: #674d0d; font-size: 20px; " href="present.php" >Present Attendance</a>
...
<br>
 <div class="regs" style="width: 8%; "> 
<h2>

  <a onclick="return confirm('remind people attend umuganda activity ?')"  href="remind_attend.php" style="color: #674d0d; font-size: 20px; " >Remind Attend</a>
