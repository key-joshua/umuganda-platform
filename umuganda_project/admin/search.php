...
<?php foreach($people as $person): ?>
          <tr><td><?= $person->PROVINCE; ?></td>
            ...
            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              ...
              <a style="color: #134805; font-size: 25px;" onclick="return confirm('Are you sure you want to Edit this User?')" href="people_edit.php?ID_NUMBER=<?= $person->ID_NUMBER ?>" class="btn btn-info">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp


              <a style="color: #7d0511;font-size: 25px;" onclick="return confirm('Are you sure you want to delete this User?')" href="people_delete.php?ID_NUMBER=<?= $person->ID_NUMBER ?>" class='btn btn-danger'>Delete</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<?php foreach($people2 as $person2): ?>
          <tr><td><?= $person2->PROVINCE; ?></td>
            ...
            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              ...
              <a style="color: #134805; font-size: 25px;" onclick="return confirm('Are you sure you want to Edit this User?')" href="people_edit.php?ID_NUMBER=<?= $person2->ID_NUMBER ?>" class="btn btn-info">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp


              <a style="color: #7d0511;font-size: 25px;" onclick="return confirm('Are you sure you want to delete this User?')" href="people_delete.php?ID_NUMBER=<?= $person2->ID_NUMBER ?>" class='btn btn-danger'>Delete</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<?php foreach($people3 as $person3): ?>
          <tr><td><?= $person3->PROVINCE; ?></td>
            ...
            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              ...
              <a style="color: #134805; font-size: 25px;" onclick="return confirm('Are you sure you want to Edit this User?')" href="people_edit.php?ID_NUMBER=<?= $person3->ID_NUMBER ?>" class="btn btn-info">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp


              <a style="color: #7d0511;font-size: 25px;" onclick="return confirm('Are you sure you want to delete this User?')" href="people_delete.php?ID_NUMBER=<?= $person3->ID_NUMBER ?>" class='btn btn-danger'>Delete</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<?php foreach($people4 as $person4): ?>
          <tr><td><?= $person4->PROVINCE; ?></td>
            ...
            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              ...
              <a style="color: #134805; font-size: 25px;" onclick="return confirm('Are you sure you want to Edit this User?')" href="people_edit.php?ID_NUMBER=<?= $person4->ID_NUMBER ?>" class="btn btn-info">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp


              <a style="color: #7d0511;font-size: 25px;" onclick="return confirm('Are you sure you want to delete this User?')" href="people_delete.php?ID_NUMBER=<?= $person4->ID_NUMBER ?>" class='btn btn-danger'>Delete</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<?php foreach($people5 as $person5): ?>
          <tr><td><?= $person5->PROVINCE; ?></td>
            ...
            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              ...
              <a style="color: #134805; font-size: 25px;" onclick="return confirm('Are you sure you want to Edit this User?')" href="people_edit.php?ID_NUMBER=<?= $person5->ID_NUMBER ?>" class="btn btn-info">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp


              <a style="color: #7d0511;font-size: 25px;" onclick="return confirm('Are you sure you want to delete this User?')" href="people_delete.php?ID_NUMBER=<?= $person5->ID_NUMBER ?>" class='btn btn-danger'>Delete</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<?php foreach($people6 as $person6): ?>
          <tr><td><?= $person6->PROVINCE; ?></td>
            ...
            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              ...
              <a style="color: #134805; font-size: 25px;" onclick="return confirm('Are you sure you want to Edit this User?')" href="people_edit.php?ID_NUMBER=<?= $person6->ID_NUMBER ?>" class="btn btn-info">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp


              <a style="color: #7d0511;font-size: 25px;" onclick="return confirm('Are you sure you want to delete this User?')" href="people_delete.php?ID_NUMBER=<?= $person6->ID_NUMBER ?>" class='btn btn-danger'>Delete</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<?php foreach($people7 as $person7): ?>
          <tr><td><?= $person7->PROVINCE; ?></td>
            ...
            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              ...
              <a style="color: #134805; font-size: 25px;" onclick="return confirm('Are you sure you want to Edit this User?')" href="people_edit.php?ID_NUMBER=<?= $person7->ID_NUMBER ?>" class="btn btn-info">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp


              <a style="color: #7d0511;font-size: 25px;" onclick="return confirm('Are you sure you want to delete this User?')" href="people_delete.php?ID_NUMBER=<?= $person7->ID_NUMBER ?>" class='btn btn-danger'>Delete</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<?php foreach($people8 as $person8): ?>
          <tr><td><?= $person8->PROVINCE; ?></td>
            ...
            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              ...
              <a style="color: #134805; font-size: 25px;" onclick="return confirm('Are you sure you want to Edit this User?')" href="people_edit.php?ID_NUMBER=<?= $person8->ID_NUMBER ?>" class="btn btn-info">Edit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp


              <a style="color: #7d0511;font-size: 25px;" onclick="return confirm('Are you sure you want to delete this User?')" href="people_delete.php?ID_NUMBER=<?= $person8->ID_NUMBER ?>" class='btn btn-danger'>Delete</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
